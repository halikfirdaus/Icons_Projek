...
class _BelajarNavBarState extends State<BelajarNavBar> {
  ...
  var _halamann = <Widget>[
    Icon(Icons.home, size: 300, color: Colors.blue),
    Icon(Icons.assignment, size: 300, color: Colors.blue),
    Icon(Icons.mail, size: 300, color: Colors.blue),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: _halamann.elementAt(_selectedNavbar)),
